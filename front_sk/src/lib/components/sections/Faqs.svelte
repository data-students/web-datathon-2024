...
<div id="faqs" class="w-[90%] sm:w-[85%] grid grid-cols-1 lg:grid-cols-2 items-start pb-40 mt-52 ">
    ...
    <div class="flex flex-col items-center ">
        <Card className="w-full sm:w-[90%] bg-terc p-12 flex flex-col mb-20 drop-shadow-sm">
    ...
    <div class="flex flex-col items-center">
        {#each faqs.slice(1) as section}
            <Card className="w-[90%] sm:w-[90%] bg-terc p-10 flex flex-col mb-10 drop-shadow-sm">
