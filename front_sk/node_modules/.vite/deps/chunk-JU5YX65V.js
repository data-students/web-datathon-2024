...
function createRawSnippet(fn) {
  return (anchor, ...params) => {
    ...
    if (hydrating) {
      ...
      element2 = /** @type {Element} */
      fragment.firstChild;
      if (DEV && (element2.nextSibling !== null || element2.nodeType !== 3)) {
        invalid_raw_snippet_render();
      }
...
function set_attributes(element2, prev, next2, lowercase_attributes, css_hash, skip_warning) {
...
//# sourceMappingURL=chunk-JU5YX65V.js.map
